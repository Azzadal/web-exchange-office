let chekedPair;
// const changePair = document.getElementById('current');
const data = {
    series: [
        [],
        []
        ...
        if (pair === chekedPair) {
            ...
            function getRate(json, fieldBuy, fieldSell) {
                if (json !== undefined) {
                    ...
                    console.log('Ожидание данных...', json)
                }
            }
        }
        else console.log('не сошлось')
    }
}
const ttt = new Obj();
...
function outTotal() {
    ...
    switch (chekedPair) {
        case 'rateUR':
            rateBuy = rateBuyUR.value;
            break;
        case 'rateER':
            rateBuy = rateBuyER.value;
            break;
        case 'rateUE':
            rateBuy = rateBuyUE.value;
            break;
        case 'rateEU':
            rateBuy = rateBuyEU.value;
            break;
    }
